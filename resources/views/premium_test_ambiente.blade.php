...
@section('head')
    ...
    <title>Clinkin - Campo Ambiente</title>
               ...
               <div class="container">
                    <div class="row">
                        ...
                        <div class="col-sm-2" style="text-align: center;">
                            ...
                            <button type="button" class="btn btn-info col-sm-12" style="margin:5px;">Ambiente</button>
...
@section('scripts')
    ...
    <script type="text/javascript">
        ...
        function nextButtonClicked(){
            window.location = "premium_test_personalidad";
        }
