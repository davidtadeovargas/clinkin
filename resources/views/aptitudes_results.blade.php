...
@section('head')
    ...
    <title>Clinkin - Conoce tus aptitudes y habilidades (Resultados)</title>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-10 col-md-10 col-12 d-flex flex-column justify-content-center align-items-center">
                              <div class="hero-text" style="text-align: center;padding: 0px !important">
                                   ...
                                   <h1 class="text-white" data-aos="fade-up">Tus aptitudes y habilidades</h1>
                                   <br><br>
                                   <div class="row">
                                        <div class="col-sm-4">
...
@section('scripts')
    ...
    <script type="text/javascript">
        ...
        function nextButtonClick(){
            window.location = "intereses_index";
        }
