...
@section('body')
    ...
    <!-- HERO -->
     <section class="hero d-flex justify-content-center align-items-center" style="background-image: url('./images/fondolargo.png');background-size: no-repeat;">
               <div class="container">
                    <div class="row">
                        ...
                        <div class="col-lg-10 col-md-10 col-12 d-flex flex-column justify-content-center align-items-center">
                              <div class="hero-text" style="text-align: center;padding: 0px !important">
                                   ...
                                   <p class="text-white" data-aos="fade-up" style="font-size: 16px;opacity: 0.7;background-color: black;padding: 2em;border-radius: 10px;">¿Qué tanto te gustaría realizar las siguientes actividades?<br>
                                   Clasificalas de acuerdo a tu interés por realizarlas, sin importar las habilidades que tengas en este momento.</p>
                                   <br>
...
@section('scripts')
    ...
    <script type="text/javascript">
        ...
        function nextButtonClicked(){
            ...
            $.ajax({
                type: 'POST',
                url: '{{ \Config::get("APP_URL") }}/api/intereses/send_test',
                ...
                success: function(data) { 
                    ...
                    if(data.res == "ok"){
                      ...
                      window.location.href = "intereses_results";
                    }
                    else{
