...
<head>
     ...
     <title>Clinkin - Premium - Tus áreas profesionales</title>
<!--
...
-->
     ...
     <script type="text/javascript">
        ...
        function startTestClick(){
            window.location = "premium_results_report_carreras_ideales";
        }
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-md-10 col-12 d-flex flex-column justify-content-center align-items-center">
                              <div class="hero-text" style="text-align: center;">
                                   ...
                                   <h1 class="text-white" data-aos="fade-up" style="color:#009999 !important;font-weight: bold;text-decoration: underline;font-size: 30px">Tus áreas profesionales</h1><br><br><br>

                                    <div class="row">
                                      <div class="col-sm-3">
                                          <img src="./images/Calculo_.png" class="col-sm-12" alt="">
                                        </div>
                                      <div class="col-sm-9">
                                   ...
                                   <br>
                                    <div class="row">
                                        ...
                                        <div class="col-sm-1">
                                            <button class="btn btn-info" type="button" onclick="startTestClick()" style="border-radius: 20px;display: <?php 
