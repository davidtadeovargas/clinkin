...
@section('head')
    ...
    <title>Clinkin - Campo Personalidad</title>
               ...
               <div class="container">
                    <div class="row">
                        ...
                        <div class="col-sm-2" style="text-align: center;">
                            ...
                            <button type="button" class="btn btn-info col-sm-12" style="margin:5px;">Personalidad</button>
                        </div>
                        <div class="col-sm-10 d-flex flex-column justify-content-center align-items-center">
                              <div class="hero-text" style="text-align: center;padding: 0px !important">
                                    <div id="dialog" data-aos="fade-up" style="background-color: white;padding: 2em;border-radius: 10px;color: black !important;margin: 10px;text-align: center;">
                                        <p class="text-white" style="font-size: 14px;color: black !important;text-align: center;">Califica en orden de tu preferencia cuál te gusta mas, siendo 6 el que más te agrade y 1 el que menos.
                                        </p><br>
                                        <div class="row">
                                            <div class="col-sm-6">
                                                <div class="row">
...
@section('scripts')
    ...
    <script type="text/javascript">
        ...
        function nextButtonClicked(){
            window.location = "premium_results_report_index";
        }
