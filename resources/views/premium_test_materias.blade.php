...
@section('head')
    ...
    <title>Clinkin - Campo Materias</title>
               ...
               <div class="container">
                    <div class="row">
                        ...
                        <div class="col-sm-2" style="text-align: center;">
                            ...
                            <button type="button" class="btn btn-dark col-sm-12" style="margin:5px;opacity: .9">Importancia</button>
                            <button type="button" class="btn btn-dark col-sm-12" style="margin:5px;">Campo aplicación</button>
                            <button type="button" class="btn btn-info col-sm-12" style="margin:5px;opacity: .9">Materias</button>
                        ...
                        <div class="col-sm-10 d-flex flex-column justify-content-center align-items-center">
                              <div class="hero-text" style="text-align: center;padding: 0px !important">
                                    <div id="dialog" data-aos="fade-up" style="background-color: white;padding: 2em;border-radius: 10px;color: black !important;margin: 10px;text-align: center;">
                                        <p class="text-white" style="font-size: 14px;color: black !important;text-align: center;">Califica en orden de tu preferencia, poniendo 6 al objetivo que más te agrade y 1 al que menos te agrade.
                                        </p><br>
                                        <div class="row">
                                            <div class="col-sm-6">
                                                <div class="row">
...
@section('scripts')
    ...
    <script type="text/javascript">
        ...
        function nextButtonClicked(){
            window.location = "premium_test_aptitudes";
        }
