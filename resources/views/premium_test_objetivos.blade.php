...
@section('head')
    ...
    <title>Clinkin - Premium Objetivos</title>
               ...
               <div class="container">
                    <div class="row">
                        ...
                        <div class="col-sm-2" style="text-align: center;">
                            <button type="button" class="btn btn-info col-sm-12" style="margin:5px;">Objetivos</button>
...
@section('scripts')
    ...
    <script type="text/javascript">
        ...
        function nextButtonClicked(){
            window.location = "premium_test_importancia";
        }
